...
>
> 完整工作流编排器。从2690行/152KB精简至130行/4.5KB（压缩96%），拆分为3个职责独立的子技能。
...
hotspot-blade（编排器）
  ...
  ├── toutiao-viral-writing → 写作模板（已有技能）
  ├── russell-flip-arsenal  → 罗素翻转弹药库（4个翻转引擎：冲动驱动论/占有vs创造/战争即无聊的解药/教育即偏见制造机）
...
| 文件 | 说明 |
|------|------|
| `SKILL.md` | 热点刀锋编排器（130行） |
| `SKILL-hotlist-scraper.md` | 数据采集子技能（curl+Cookie直连5平台） |
| `SKILL-topic-scorer.md` | 选题评分子技能（5维度+S/A评级+PPT报告） |
| `SKILL-russell-flip-arsenal.md` | 罗素翻转弹药库（4个引擎：冲动驱动论/占有vs创造/战争即无聊的解药/教育即偏见制造机） |
